...
namespace Muster.Persistence.Migrations
{
    ...
    [Migration("20260526192517_RenameLedgerDropManualAwards")]
    partial class RenameLedgerDropManualAwards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Muster.Domain.Entities.CurrencyLedgerEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Muster.Domain.Entities.Currency", b =>
                {
                    b.OwnsOne("Muster.Domain.Entities.CurrencyConnector", "Connector", b1 =>
                        {
                            ...
                            b1.OwnsOne("Muster.Domain.Entities.ConnectorAuth", "Auth", b2 =>
                                {
                            ...
                            b1.OwnsMany("Muster.Domain.Entities.ConnectorHeader", "Headers", b2 =>
                                {
                                    b2.Property<Guid>("CurrencyConnectorCurrencyId");
                            ...
                            b1.OwnsOne("Muster.Domain.Entities.ConnectorSigning", "Signing", b2 =>
                                {
                                    b2.Property<Guid>("CurrencyConnectorCurrencyId");
                            ...
                            b1.OwnsOne("Muster.Domain.Entities.ConnectorAction", "Credit", b2 =>
                                {
                                    b2.Property<Guid>("CurrencyConnectorCurrencyId");
                            ...
                            b1.OwnsOne("Muster.Domain.Entities.ConnectorAction", "Debit", b2 =>
                                {
                                    b2.Property<Guid>("CurrencyConnectorCurrencyId");
                            ...
                            b1.OwnsOne("Muster.Domain.Entities.ConnectorAction", "GetBalance", b2 =>
                                {
                                    b2.Property<Guid>("CurrencyConnectorCurrencyId");
