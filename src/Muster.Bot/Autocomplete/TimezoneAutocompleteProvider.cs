...
public class TimezoneAutocompleteProvider : IAutocompleteProvider<AutocompleteInteractionContext>
{
    ...
    [
        ...
        "America/Mexico_City", "America/Sao_Paulo", "Europe/London", "Europe/Paris", "Europe/Berlin", "Europe/Madrid",
        "Europe/Moscow", "Africa/Cairo", "Africa/Johannesburg", "Asia/Dubai", "Asia/Kolkata", "Asia/Bangkok",
