...
public class BountyModule(IServiceScopeFactory scopeFactory) : MusterModuleBase(scopeFactory)
{
    ...
    public Task<string> TakeAsync([SlashCommandParameter(Name = "bounty", Description = "Bounty", AutocompleteProviderType = typeof(BountyAutocompleteProvider))] string bounty)
    ...
    public Task<string> SubmitAsync([SlashCommandParameter(Name = "bounty", Description = "Bounty", AutocompleteProviderType = typeof(BountyAutocompleteProvider))] string bounty)
    ...
    public Task<string> ConfirmAsync([SlashCommandParameter(Name = "bounty", Description = "Bounty", AutocompleteProviderType = typeof(BountyAutocompleteProvider))] string bounty)
    ...
    public Task<string> CancelAsync([SlashCommandParameter(Name = "bounty", Description = "Bounty", AutocompleteProviderType = typeof(BountyAutocompleteProvider))] string bounty)
    ...
    public Task<string> DisputeAsync([SlashCommandParameter(Name = "bounty", Description = "Bounty", AutocompleteProviderType = typeof(BountyAutocompleteProvider))] string bounty)
