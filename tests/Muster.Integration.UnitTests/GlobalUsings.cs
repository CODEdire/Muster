// Domain entities live in feature sub-namespaces (Muster.Domain.Entities.<Feature>); import them all here so
// existing references keep resolving without per-file using churn.
...
global using Muster.IntegrationTests.TestSupport;
